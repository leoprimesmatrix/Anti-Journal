...
const translations: Record<Language, Translation> = {
  en: {
    ...
    plansTitle: "Choose Your Protocol",
    plansSubtitle: "Begin your journey into the void. Upgrade to Pro for the ultimate release experience.",
    planFreeName: "Initiate",
    planFreePrice: "$0/forever",
    planFreeDesc: "The core anti-journaling experience.",
    planFreeFeature1: "Core release mechanics & hold-to-release",
    planFreeFeature2: "5 Base Themes (Stardust, Obsidian, Void, etc.)",
    planFreeFeature3: "Standard destruction animations",
    planFreeFeature4: "End-to-end ephemeral architecture",
    planFreeCTA: "Start Free",
    planProName: "Pro Protocol",
    planProPrice: "$4.99/month",
    planProDesc: "Unlock the full cosmic void.",
    planProFeature1: "Everything in Initiate",
    planProFeature2: "13+ Premium Themes (Liquid Glass, Nebula, etc.)",
    planProFeature3: "Advanced physics & destruction animations",
    planProFeature4: "Exclusive ambient backgrounds & soundscapes",
    planProCTA: "Upgrade in App",
  ...
  es: {
    ...
    heroCTA: "Solicitar Acceso Temprano",
    navHome: "Inicio",
    ...
    plansTitle: "Elige tu Protocolo",
    plansSubtitle: "Comienza tu viaje hacia el vacío. Actualiza a Pro para la experiencia de liberación definitiva.",
    planFreeName: "Iniciado",
    planFreePrice: "$0/siempre",
    planFreeDesc: "La experiencia central de anti-diario.",
    planFreeFeature1: "Mecánica central de liberación y mantener para liberar",
    planFreeFeature2: "5 Temas Base (Stardust, Obsidian, Void, etc.)",
    planFreeFeature3: "Animaciones de destrucción estándar",
    planFreeFeature4: "Arquitectura efímera de extremo a extremo",
    planFreeCTA: "Empezar Gratis",
    planProName: "Protocolo Pro",
    planProPrice: "$4.99/mes",
    planProDesc: "Desbloquea el vacío cósmico completo.",
    planProFeature1: "Todo lo de Iniciado",
    planProFeature2: "13+ Temas Premium (Liquid Glass, Nebula, etc.)",
    planProFeature3: "Física avanzada y animaciones de destrucción",
    planProFeature4: "Fondos ambientales y paisajes sonoros exclusivos",
    planProCTA: "Actualizar en la App",
  ...
  ko: {
    ...
    plansTitle: "프로토콜 선택",
    plansSubtitle: "공허로의 여정을 시작하세요. 궁극의 해방 경험을 위해 Pro로 업그레이드하세요.",
    planFreeName: "입문",
    planFreePrice: "$0/영원히",
    planFreeDesc: "핵심 안티 저널링 경험.",
    planFreeFeature1: "핵심 해방 메커니즘 및 홀드 투 릴리스",
    planFreeFeature2: "5가지 기본 테마 (Stardust, Obsidian, Void 등)",
    planFreeFeature3: "표준 파괴 애니메이션",
    planFreeFeature4: "엔드 투 엔드 휘발성 아키텍처",
    planFreeCTA: "무료로 시작",
    planProName: "프로 프로토콜",
    planProPrice: "$4.99/월",
    planProDesc: "완전한 우주적 공허를 잠금 해제하세요.",
    planProFeature1: "입문의 모든 기능",
    planProFeature2: "13개 이상의 프리미엄 테마 (Liquid Glass, Nebula 등)",
    planProFeature3: "고급 물리 및 파괴 애니메이션",
    planProFeature4: "독점적인 앰비언트 배경 및 사운드스케이프",
    planProCTA: "앱에서 업그레이드",
    recommended: "추천",
    appTitle: "안티 저널",
  ...
  ja: {
    ...
    plansTitle: "プロトコルを選択",
    plansSubtitle: "虚無への旅を始めましょう。究極の解放体験のためにProにアップグレードしてください。",
    planFreeName: "イニシエート",
    planFreePrice: "$0/永久に",
    planFreeDesc: "コアなアンチジャーナリング体験。",
    planFreeFeature1: "コアな解放メカニズムと長押しで解放",
    planFreeFeature2: "5つの基本テーマ (Stardust, Obsidian, Voidなど)",
    planFreeFeature3: "標準的な破壊アニメーション",
    planFreeFeature4: "エンドツーエンドの儚いアーキテクチャ",
    planFreeCTA: "無料で開始",
    planProName: "プロ・プロトコル",
    planProPrice: "$4.99/月",
    planProDesc: "完全な宇宙の虚无をアンロック。",
    planProFeature1: "イニシエートの全機能",
    planProFeature2: "13以上のプレミアムテーマ (Liquid Glass, Nebulaなど)",
    planProFeature3: "高度な物理演算と破壊アニメーション",
    planProFeature4: "独占的なアンビエント背景とサウンドスケープ",
    planProCTA: "アプリでアップグレード",
    recommended: "おすすめ",
    appTitle: "アンチジャーナル",
  ...
  zh: {
    ...
    plansTitle: "选择您的协议",
    plansSubtitle: "开始您的虚空之旅。升级到 Pro 以获得终极释放体验。",
    planFreeName: "启程",
    planFreePrice: "$0/永久",
    planFreeDesc: "核心反日志体验。",
    planFreeFeature1: "核心释放机制和长按释放",
    planFreeFeature2: "5个基础主题 (Stardust, Obsidian, Void等)",
    planFreeFeature3: "标准破坏动画",
    planFreeFeature4: "端到端短暂架构",
    planFreeCTA: "免费开始",
    planProName: "专业协议",
    planProPrice: "$4.99/月",
    planProDesc: "解锁完整的宇宙虚空。",
    planProFeature1: "包含启程的所有功能",
    planProFeature2: "13+ 高级主题 (Liquid Glass, Nebula等)",
    planProFeature3: "高级物理和破坏动画",
    planProFeature4: "独家环境背景和音景",
    planProCTA: "在应用中升级",
    recommended: "推荐",
    appTitle: "反日志",
  ...
  fr: {
    ...
    plansTitle: "Choisissez Votre Protocole",
    plansSubtitle: "Commencez votre voyage dans le vide. Passez à Pro pour l'expérience de libération ultime.",
    planFreeName: "Initié",
    planFreePrice: "0 €/toujours",
    planFreeDesc: "L'expérience de base de l'anti-journal.",
    planFreeFeature1: "Mécanismes de libération de base et maintien pour libérer",
    planFreeFeature2: "5 thèmes de base (Stardust, Obsidian, Void, etc.)",
    planFreeFeature3: "Animations de destruction standard",
    planFreeFeature4: "Architecture éphémère de bout en bout",
    planFreeCTA: "Commencer Gratuitement",
    planProName: "Protocole Pro",
    planProPrice: "4,99 €/mois",
    planProDesc: "Débloquez le vide cosmique complet.",
    planProFeature1: "Tout ce qui est inclus dans Initié",
    planProFeature2: "13+ thèmes premium (Liquid Glass, Nebula, etc.)",
    planProFeature3: "Physique avancée et animations de destruction",
    planProFeature4: "Arrière-plans ambiants et paysages sonores exclusifs",
    planProCTA: "Mettre à niveau dans l'App",
  ...
  de: {
    ...
    heroCTA: "Frühen Zugang anfordern",
    navHome: "Home",
    navFeatures: "Features",
    navMission: "Mission",
    navPhilosophy: "Philosophie",
    ...
    plansTitle: "Wähle dein Protokoll",
    plansSubtitle: "Beginne deine Reise in die Leere. Upgrade auf Pro für das ultimative Befreiungserlebnis.",
    planFreeName: "Initiant",
    planFreePrice: "0 €/immer",
    planFreeDesc: "Das Kern-Anti-Journaling-Erlebnis.",
    planFreeFeature1: "Kern-Befreiungsmechanik & Halten zum Befreien",
    planFreeFeature2: "5 Basis-Themen (Stardust, Obsidian, Void, etc.)",
    planFreeFeature3: "Standard-Zerstörungsanimationen",
    planFreeFeature4: "End-to-End flüchtige Architektur",
    planFreeCTA: "Kostenlos starten",
    planProName: "Pro-Protokoll",
    planProPrice: "4,99 €/Monat",
    planProDesc: "Schalte die volle kosmische Leere frei.",
    planProFeature1: "Alles aus Initiant",
    planProFeature2: "13+ Premium-Themen (Liquid Glass, Nebula, etc.)",
    planProFeature3: "Fortgeschrittene Physik & Zerstörungsanimationen",
    planProFeature4: "Exklusive Ambient-Hintergründe & Soundscapes",
    planProCTA: "In der App upgraden",
