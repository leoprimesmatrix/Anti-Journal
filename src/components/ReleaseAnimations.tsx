...
export const ANIMATIONS_CONFIG: Record<string, { name: string, duration: number, description: string, isNew?: boolean }> = {
  vortexConsume: { name: 'Vortex Consume', duration: 5000, description: 'Pulled into the event horizon of a black hole.', isNew: true },
  singularityCollapse: { name: 'Singularity Collapse', duration: 5000, description: 'Plunge into the event horizon of a collapsing star.', isNew: true },
  supernova: { name: 'Supernova', duration: 5000, description: 'A massive explosion of light and particles.' },
  incinerate: { name: 'Incinerate', duration: 6000, description: 'Burn your words to ash in a roaring fire.' },
  nebula: { name: 'Nebula Dissolve', duration: 6000, description: 'Melt into a massive, colorful cosmic cloud.' },
  singularity: { name: 'Singularity', duration: 4500, description: 'Collapse into a dense point of infinite gravity.' },
  abyssSink: { name: 'Abyss Sink', duration: 6000, description: 'Sink your thoughts into the dark depths of the ocean.' },
  sandstorm: { name: 'Sandstorm', duration: 5000, description: 'Let your words blow away like dust in the wind.' },
  voidConsume: { name: 'Void Consume', duration: 6000, description: 'A creeping darkness swallows everything.' },
  ascension: { name: 'Ascension', duration: 5500, description: 'Shatter and rise as glowing embers.' },
  quantum: { name: 'Quantum Glitch', duration: 4000, description: 'Vibrate across dimensions and snap out of existence.' },
  bloodMoon: { name: 'Blood Moon', duration: 6000, description: 'A deep crimson eclipse consumes your words.' },
  goldenRain: { name: 'Golden Rain', duration: 5500, description: 'Melt into a shower of golden light.' },
  matrix: { name: 'Matrix Decode', duration: 5000, description: 'Dissolve into digital rain.' },
  glassShatter: { name: 'Glass Shatter', duration: 4000, description: 'Break your thoughts into sharp, falling fragments.', isNew: true },
  cherryBlossom: { name: 'Cherry Blossom', duration: 6000, description: 'Fade gently into falling petals.', isNew: true },
  glacialFreeze: { name: 'Glacial Freeze', duration: 5000, description: 'Freeze over and crack into ice.', isNew: true },
  prismaticBurst: { name: 'Prismatic Burst', duration: 4000, description: 'Explode into a spectrum of vibrant colors.', isNew: true },
  
  // Live Atmosphere Specific Animations
  midnightRain: { name: 'Midnight Rain', duration: 5000, description: 'Wash away your thoughts like rain on a window.', isNew: true },
  emberDrift: { name: 'Ember Drift', duration: 5500, description: 'Let your words evaporate into warm steam.', isNew: true },
  cityLightsBlur: { name: 'City Lights Blur', duration: 4500, description: 'Dissolve into the blurred bokeh of urban nights.', isNew: true },
  windowFrost: { name: 'Window Frost', duration: 6000, description: 'Freeze over and slowly melt away.', isNew: true },
  subwayRush: { name: 'Subway Rush', duration: 4000, description: 'Swept away by the speed of a passing train.', isNew: true },
  lofiGlitch: { name: 'Lo-Fi Glitch', duration: 4500, description: 'A nostalgic, VHS-style distortion.', isNew: true },
  highwaySpeed: { name: 'Highway Speed', duration: 5000, description: 'Speed away into the warm colors of dusk.', isNew: true },
  forestMist: { name: 'Forest Mist', duration: 6000, description: 'Enveloped and hidden by a dense, quiet fog.', isNew: true },
  tideWash: { name: 'Tide Wash', duration: 5500, description: 'Washed out to sea by a gentle wave.', isNew: true },
  waterfallCrash: { name: 'Waterfall Crash', duration: 5000, description: 'Plunge into the rushing waters below.', isNew: true },
  blizzardSweep: { name: 'Blizzard Sweep', duration: 5500, description: 'Scattered by a sudden, freezing wind.', isNew: true },
  neonFlicker: { name: 'Neon Flicker', duration: 4000, description: 'Buzz, flicker, and short-circuit into darkness.', isNew: true },
  goldenHourFade: { name: 'Golden Hour Fade', duration: 6000, description: 'Fade softly into the warm, setting sun.', isNew: true },
  cyberpunkShatter: { name: 'Cyberpunk Shatter', duration: 4500, description: 'Fragment into glowing, neon data shards.', isNew: true },
  meteorShower: { name: 'Meteor Shower', duration: 8000, description: 'Burn up upon atmospheric entry.', isNew: true },
  cosmicBloom: { name: 'Cosmic Bloom', duration: 6000, description: 'Expand into a beautiful, stellar nursery.', isNew: true },
  moonlightRipple: { name: 'Moonlight Ripple', duration: 5500, description: 'Distorted and lost in the reflection of the moon.', isNew: true },
};
